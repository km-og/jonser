  ...
  return (
    <section className="privacy">
      ...
      <div className="privacy__container">
        <h3 className="privacy__subtitle">1. Общие положения</h3>
        <p className="privacy__text">
          ...
          безопасности персональных данных, предпринимаемые Глушков Константин
          Сергеевич (далее — Оператор).
        </p>
        <ol className="privacy__list">
          ...
          <li className="privacy__item">
            ...
            Оператор может получить о посетителях веб-сайта https://jonser.ru/.
          </li>
        </ol>
      </div>
      <div className="privacy__container">
        ...
        <ol className="privacy__list">
          ...
          <li className="privacy__item">
            ...
            доступность в сети интернет по сетевому адресу http://jonser.ru/.
          </li>
          <li className="privacy__item">
          ...
          <li className="privacy__item">
            2.10. Пользователь — любой посетитель веб-сайта http://jonser.ru/.
          </li>
          <li className="privacy__item">
      ...
      <div className="privacy__container">
        ...
        <ol className="privacy__list">
          <li className="privacy__item">
            ...
            <ul className="privacy__under-list">
              <li className="privacy__under-item">
        ...
        <table className="privacy__table">
          <tbody>
            <tr>
              ...
              <td>
                информирование Пользователя посредством телефонного звонка
              </td>
            </tr>
            <tr>
      ...
      <div className="privacy__container">
        ...
        <ol className="privacy__list">
          ...
          <li className="privacy__item">
            ...
            Оператора glushkov.k@gmail.com с пометкой «Актуализация персональных
            данных».
          </li>
          <li className="privacy__item">
            ...
            glushkov.k@gmail.com с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
          <li className="privacy__item">
      ...
      <div className="privacy__container">
        <h3 className="privacy__subtitle">12. Заключительные положения</h3>
        <ol className="privacy__list">
          <li className="privacy__item">
            ...
            к Оператору с помощью электронной почты glushkov.k@gmail.com.
          </li>
          <li className="privacy__item">
          ...
          <li className="privacy__item">
            ...
            сети Интернет по адресу http://jonser.ru/privacy.
          </li>
        </ol>
      </div>
    </section>
