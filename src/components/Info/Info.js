...
function Info() {
  return (
    <div className="info" id="delivery">
      <ul className="info__list">
        ...
        <li className="info__column">
          ...
          <p className="info__text">
            Гарантия, длительностью от 24 месяцев со дня приобретения,
        ...
        <li className="info__column">
          ...
          <p className="info__text">
            ...
            продукции. Мы гарантируем, что Ваш заказ будет доставлен вовремя и
            без повреждений, благодаря нашим профессиональным курьерам и
            надежной упаковке.
          </p>
        </li>
      </ul>
